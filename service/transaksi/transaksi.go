...
type Transaksi interface {
	...
	GetTransaksiFilter(umkmID uuid.UUID, filtersTanggal map[string]string, allowedfiltersTanggal []string, filters string, limit int, page int, status string) (*TransaksiFilterResult, error)
